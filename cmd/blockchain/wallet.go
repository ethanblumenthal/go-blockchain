...
func walletNewAccountCmd() *cobra.Command {
	var cmd = &cobra.Command {
		Use: "new-account",
		Short: "Creates a new account with a set of public and private keys",
		Run: func(cmd *cobra.Command, args []string) {
...
func getPassPhrase(promt string, confirmation bool) string {
	password, err := console.Stdin.PromptPassword(promt)
	if err != nil {
